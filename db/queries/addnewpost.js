...
const addNewPost = (post) => {
  const query = `INSERT INTO posts (user_id, topic, title, description, external_url, url_image, rating, likes, date) VALUES ($6, $1, $2, $3, $4, $5, 0, 0, Now());`;
  ...
  return db.query(query, [topic, title, description, externalUrl, urlImage, user_id])
  // return db.query(qs3)
    .then(data => {
